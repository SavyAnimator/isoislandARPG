...
return [
    ...
    */
    ...
    // SURRENDER_ACCEPTED
    218 => [
        'name' => 'Donated Character Approved',
        'message' => 'Your character donation (#{surrender_id}) was approved by <a href="{staff_url}">{staff_name}</a>. (<a href="{url}">View Donation</a>)',
        'url' => 'surrender/view/{surrender_id}'
    ],

    // surrenders_REJECTED
    219 => [
        'name' => 'Donated Character Rejected',
        'message' => 'Your character donation (#{surrender_id}) was rejected by <a href="{staff_url}">{staff_name}</a>. (<a href="{url}">View Donation</a>)',
        'url' => 'surrender/view/{surrender_id}'
    ],
    ...
    222 => [
        'name'    => 'MYO Shop Purchase',
        'message' => 'We appreciate your purchase! Your {item} has been added to your inventory (<a href="{url}">View Inventory</a>)',
        'url'     => 'inventory',
    ],
    ...
    // GEAR GRANT
    250 => [
        'name' => 'Accessory Grant',
        'message' => 'You have received a staff grant of {gear_name} (×{gear_quantity}) from <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Accessories</a>)',
        'url' => 'accessory'
    ],
    // WEAPON GRANT
    251 => [
        'name' => 'Equipment Grant',
        'message' => 'You have received a staff grant of {weapon_name} (×{weapon_quantity}) from <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Equipment</a>)',
        'url' => 'weapons'
    ],
    // WEAPON_REMOVAL
    252 => [
        'name' => 'Equipment Removal',
        'message' => '{weapon_name} (×{weapon_quantity}) was removed from your equipment by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Equipment</a>)',
        'url' => 'weapons'
    ],
    // WEAPON_TRANSFER
    253 => [
        'name' => 'Equipment Transfer',
        'message' => 'You have received {weapon_name} (×{weapon_quantity}) from <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Equipment</a>)',
        'url' => 'weapons'
    ],
    // FORCED_WEAPON_TRANSFER
    254 => [
        'name' => 'Forced Equipment Transfer',
        'message' => '{weapon_name} (×{weapon_quantity}) was transferred out of your equipment by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Equipment</a>)',
        'url' => 'weapons'
    ],
    // GEAR_REMOVAL
    255 => [
        'name' => 'Accessory Removal',
        'message' => '{gear_name} (×{gear_quantity}) was removed from your equipment by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Accessories</a>)',
        'url' => 'accessory'
    ],
    // GEAR_TRANSFER
    256 => [
        'name' => 'Accessory Transfer',
        'message' => 'You have received {gear_name} (×{gear_quantity}) from <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Accessories</a>)',
        'url' => 'accessory'
    ],
    // FORCED_GEAR_TRANSFER
    257 => [
        'name' => 'Forced Accessory Transfer',
        'message' => '{gear_name} (×{gear_quantity}) was transferred out of your equipment by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Accessories</a>)',
        'url' => 'accessory'
    ],
    // AWARD_GRANT
    341 => [
    ...
    345 => [
        'name' => 'Character Achievement Grant',
    ...
    346 => [
        'name' => 'Character Achievement Removal',
    ...
    521 => [
        'name' => 'Character Ailment Grant',
        'message' => '{character_name} has been given the ailment {status_name} (×{status_quantity}) by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Ailments</a>)',
        'url' => 'character/{character_slug}/status-effects'
    ],

    // CHARACTER_STATUS_REMOVAL
    522 => [
        'name' => 'Character Ailment Removal',
        'message' => '{status_name} (×{status_quantity})  was removed from {character_name} by <a href="{sender_url}">{sender_name}</a>. (<a href="{url}">View Ailments</a>)',
        'url' => 'character/{character_slug}/status-effects'
    ],
