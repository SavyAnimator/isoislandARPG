<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ url('shops/donation-shop') }}" class="{{ set_active('shops/donation-shop') }}">Darwin's Donations</a></div>

        <div class="sidebar-item"><a href="{{ url('adoptions') }}"  class="{{ set_active('adoptions') }}">The Daycare</a></div>

        <div class="sidebar-item"><a href="{{ url('shops/products') }}" class="{{ set_active('shops/products') }}">MYO Shop</a></div>
    </li>
</ul>
