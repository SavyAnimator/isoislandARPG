...
{{--Custom code to add Daycare to Shops--}}

    <div class="col-md-3 col-6 mb-3 text-center">
        <div class="shop-image">
            <a href="{{ url('adoptions') }}"><img src="{{ $adoption->adoptionImageUrl }}" /></a>
        </div>
        <div class="shop-name mt-1">
            <a href="{{ url('adoptions') }}" class="h5 mb-0">{{ $adoption->name }}</a>
        </div>
    </div>
    ...
    <div class="col-md-3 col-6 mb-3 text-center">
        ...
        <div class="shop-name mt-1">
            <a href="{{ url('shops/donation-shop') }}" class="h5 mb-0">Darwin's Donations</a>
        </div>
    </div>

    <div class="col-md-3 col-6 mb-3 text-center">
        <div class="shop-image">
            <a href="{{ url('shops/products') }}"><img src="{{ asset('images/myo.png') }}" /></a>
        </div>
        <div class="shop-name mt-1">
            <a href="{{ url('shops/products') }}" class="h5 mb-0">MYO Shop</a>
        </div>
    </div>
