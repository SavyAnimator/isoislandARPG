        ...
        <div class="card bg-light mb-3 collapse" id="advancedSearch">
            <div class="card-body masterlist-advanced-search">
                @if(!$isMyo)
                    ...
                    <div class="masterlist-search-field">
                        {!! Form::label('subtype_id', 'Species Breed: ') !!}
                ...
                @if(!$isMyo)
                    ...
                    <div class="masterlist-search-field">
                        {!! Form::label('rarity_id', 'Character Age: ') !!}
                        {!! Form::select('rarity_id', [0 => 'Any', 8 => 'Child', 7 => 'Adult', 9 => 'Egg'], Request::get('rarity_id'), ['class' => 'form-control']) !!}
                    </div>
                @endif
                <br />
                ...
                <div class="masterlist-search-field">
                    {!! Form::label('is_training', 'Can Be Trained by others: ') !!}
                    {!! Form::select('is_training', [0 => 'Any Trainable Status', 2 => 'Ask First', 1 => 'Yes', 3 => 'Yes OR Ask First'], Request::get('is_training'), ['class' => 'form-control']) !!}
                </div>
                <div class="masterlist-search-field">
                    {!! Form::label('is_explore', 'Can Be included in Exploration by others: ') !!}
                    {!! Form::select('is_explore', [0 => 'Any', 2 => 'Ask First', 1 => 'Yes', 3 => 'Yes OR Ask First'], Request::get('is_explore'), ['class' => 'form-control']) !!}
                </div>
