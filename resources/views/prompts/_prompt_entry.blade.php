<div class="row world-entry">
    ...
    <div class="{{ $prompt->has_image ? 'col-md-9' : 'col-12' }}">
        ...
        <div class="world-entry-text">
            ...
            <h3 class="mb-3"><a data-toggle="collapse" href="#prompt-{{ $prompt->id }}" @if(isset($isPage)) aria-expanded="true" @endif)>Rewards <i class="fas fa-angle-down"></i></a></h3>
            <div class="collapse @if(isset($isPage)) show @endif mb-5" id="prompt-{{ $prompt->id }}">
            <h5>Currency & Item Rewards</h5>
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        @foreach($prompt->rewards as $reward)
                            <tr>
                                <td>{!! $reward->reward->displayName!!} {{ $reward->rewardable_type }}</td>
            ...
            <div class="row">
                <div class="col">
                    ...
                    {{ $prompt->expreward->chara_exp ? $prompt->expreward->chara_exp : 0  }} character EXP
                        <br>
                    {{ $prompt->expreward->chara_points ? $prompt->expreward->chara_points : 0  }} stat points
                    @endif
                </div>
                {{--<div class="col">
