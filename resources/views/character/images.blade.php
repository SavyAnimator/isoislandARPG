...
@section('profile-content')
    ...
    <h2 style="display:inline;">{!! $character->displayName !!}'<h2 style="display:inline; text-transform:lowercase;">s</h2><h2 style="display:inline;"> Images</h2>
    <p>These are the official images of the character's current and past design history. To view user-submitted gallery images are visible <a href="{{ url($character->url . '/gallery') }}">here</a>.</p>
<hr>
