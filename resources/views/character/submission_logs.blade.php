...
@section('profile-content')
    ...
    <h2 style="display:inline;">{!! $character->displayName !!}'<h2 style="display:inline; text-transform:lowercase;">s</h2><h2 style="display:inline;"> Submissions</h2>
<hr>
    ...
    @if (count($logs))
        ...
        {!! $logs->render() !!}
    @else
        <p>No activity or prompt submissions found.</p>
    @endif
