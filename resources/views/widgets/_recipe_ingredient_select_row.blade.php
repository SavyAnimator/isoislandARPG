<div id="ingredientRowData" class="hide">
    <table class="table table-sm">
        <tbody id="ingredientRow">
            <tr class="ingredient-row">
                <td>{!! Form::select('ingredient_type[]', ['Item' => 'Item', 'MultiItem' => 'Multi Item', 'Category' => 'Category', 'MultiCategory' => 'Multi Category', 'Currency' => 'Currency', 'Gear' => 'Accessory', 'Weapon' => 'Equipment', 'MultiWeapon' => 'Multi Equipment'], null, ['class' => 'form-control ingredient-type', 'placeholder' => 'Select Ingredient Type']) !!}</td>
    ...
    {!! Form::select('ingredient_data[]', $gears, null, ['class' => 'form-control gear-select', 'placeholder' => 'Select Accessory']) !!}

    {!! Form::select('ingredient_data[]', $weapons, null, ['class' => 'form-control weapon-select', 'placeholder' => 'Select Equipment']) !!}

    <div class="multi-weapon-select-group">
        <div class="multi-weapon-list">
            <div class="mb-2">
                {!! Form::select('ingredient_data[][]', $weapons, null, ['class' => 'form-control multi-weapon-select', 'placeholder' => 'Select Equipment']) !!}
                <div class="text-right text-uppercase" style="margin-top: -0.5em;"><a href="#" class="remove-multi-entry-button text-danger hide">Remove Equipment</a></div>
            </div>
        </div>
        <a href="#" class="btn btn-primary add-multi-weapon-button mb-2">Add Equipment</a>
    </div>

    <div class="multi-weapon-entry mb-2">
        {!! Form::select('ingredient_data[][]', $weapons, null, ['class' => 'form-control multi-weapon-select', 'placeholder' => 'Select Equipment']) !!}
        <div class="text-right text-uppercase" style="margin-top: -0.5em;"><a href="#" class="remove-multi-entry-button text-danger">Remove Equipment</a></div>
    </div>
