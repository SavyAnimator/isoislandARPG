        ...
        <div class="row">
            <div class="col-md-2 align-items-stretch d-flex">
                <div class="d-flex text-center align-items-center">
                    <div class="character-image-blank hide">Enter character masterlist ID<br>(Example: A-1234)</div>
                                ...
                                <tr class="character-reward-row">
                                    @if ($expanded_rewards)
                                        <td>
                                            ...
                                            {!! Form::select('character_rewardable_type['.$character->character_id.'][]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Award' => 'Award','Feature' => 'Trait', 'StatusEffect' => 'Status Effect'], $reward->rewardable_type, [
