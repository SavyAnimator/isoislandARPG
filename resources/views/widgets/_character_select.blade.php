<div id="characterComponents" class="hide">
    ...
    <table>
        <tr class="character-reward-row">
            ...
            @if ($expanded_rewards)
                <td>
                    {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency','Feature' => 'Trait'] + (isset($showLootTables) && $showLootTables ? ['LootTable' => 'Loot Table'] : []) + (isset($showStatuses) && $showStatuses ? ['StatusEffect' => 'Status Effect'] : []), null, [
