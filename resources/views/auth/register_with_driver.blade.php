...
@if($userCount)
    ...
    <div class="row">
        ...
        <p>Isomara Island is currently in Early Access. To register for an account you will need an Invitation Key.<br>
            <a href="/support">Support us</a> to receive an Invitation Key via email. Follow us on <a href="https://twitter.com/Isomaraarpg">Twitter</a> and oin our <a href="https://discord.gg/62ZGCYFUDu">Discord</a> for updates and news.
        </p>
        </div>
    </div>
    <hr>
