...
@if($item->id)
    ...
    <div class="card mb-3">
        <div class="card-body">
            @include('world._item_entry', ['idUrl' => $item->idUrl, 'imageUrl' => $item->imageUrl, 'name' => $item->displayName, 'description' => $item->parsed_description, 'searchUrl' => $item->searchUrl, 'shops' => $shops])
        </div>
    </div>
@endif
