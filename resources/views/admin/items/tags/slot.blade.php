...
<div class="form-group">
    {!! Form::label('Breed (Optional)') !!} {!! add_help(
        'This will lock the slot into a particular breed. Leave it blank if you would like to give the user a choice, or not select a breed. The breed must match the species selected above, and if no species is specified, the breed will not be applied.',
    ) !!}
