    ...
    {!! Form::open(['url' => url()->current(), 'id' => 'submissionForm']) !!}
        ...
        <div id="characters" class="mb-3">
            @foreach($submission->characters as $character)
                ...
                @include('widgets._character_select_entry', ['characterCurrencies' => $characterCurrencies, 'items' => $items, 'tables' => $tables, 'character' => $character, 'characterAwards' => $characterAwards, 'expanded_rewards' => $expanded_rewards, 'features' => $features, 'submission' => true])
    ...
    <div id="characterComponents" class="hide">
                ...
                <div class="row">
                    <div class="col-md-2 align-items-stretch d-flex">
                        <div class="d-flex text-center align-items-center">
                            <div class="character-image-blank">Enter character masterlist ID<br>(Example: A-1234)</div>
        ...
        <table>
            <tr class="character-reward-row">
                    ...
                    @if($expanded_rewards)
                    <td>
                        {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Award' => 'Award','Feature' => 'Trait', 'StatusEffect' => 'Status Effect'], null, ['class' => 'form-control character-rewardable-type', 'placeholder' => 'Select Reward Type']) !!}
                    </td>
                    <td class="lootDivs">
