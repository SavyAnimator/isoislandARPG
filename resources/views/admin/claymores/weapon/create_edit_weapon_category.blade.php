...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Equipment Categories' => 'admin/weapon/weapon-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/weapon/weapon-categories/edit/'.$category->id : 'admin/weapon/weapon-categories/create']) !!}
