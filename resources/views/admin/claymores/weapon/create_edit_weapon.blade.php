...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Equipment' => 'admin/weapon', ($weapon->id ? 'Edit' : 'Create').' Weapon' => $weapon->id ? 'admin/weapon/edit/'.$weapon->id : 'admin/weapon/create']) !!}

<h1>{{ $weapon->id ? 'Edit' : 'Create' }} Equipment
    @if($weapon->id)
        <a href="#" class="btn btn-outline-danger float-right delete-weapon-button">Delete Equipment</a>
    @endif
</h1>
