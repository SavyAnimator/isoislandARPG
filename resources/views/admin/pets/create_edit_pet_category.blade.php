...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Critter Categories' => 'admin/data/pet-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/pet-categories/edit/'.$category->id : 'admin/data/pet-categories/create']) !!}
