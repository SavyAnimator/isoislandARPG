...
<p>Click on a user's name to view/edit their profile.</p>
...
<div class="mb-4 logs-table">
    <div class="logs-table-header">
        <div class="row">
            ...
            <div class="col-4 col-md-3"><div class="logs-table-cell">Alias</div></div>
        ...
        @foreach($users as $user)
            <div class="logs-table-row">
                <div class="row flex-wrap">
                    <div class="col-12 col-md-4 "><div class="logs-table-cell"><a href="{{ $user->adminUrl }}">{!! $user->is_banned ? '<strike>' : '' !!}{{ $user->name }}{!! $user->is_banned ? '</strike>' : '' !!}</a></div></div>
                    ...
                    <div class="col-4 col-md-3"><div class="logs-table-cell">{!! pretty_date($user->created_at) !!}</div></div>
                </div>
            </div>
        @endforeach
    </div>
