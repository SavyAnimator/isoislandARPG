...
<p>You can create and edit ranks to assign to users here. Ranks can have powers attached, which allows users with the rank to view and edit data on certain parts of the site. To assign a rank to a user, find their admin page from the <a href="{{ url('admin/users') }}">User List</a> and change their rank there.</p>
