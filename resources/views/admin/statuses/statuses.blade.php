...
@section('admin-title') Ailments @endsection
...
<p>This is a list of ailments that can be applied to characters. Ailments can be distributed much like other rewards, including from prompts, loot tables, and so on.</p>

<div class="text-right mb-3"><a class="btn btn-primary" href="{{ url('admin/data/status-effects/create') }}"><i class="fas fa-plus"></i> Create New Inflicton/Ailment</a></div>
