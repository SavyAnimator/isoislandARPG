...
@section('admin-title') Grant Critters @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Grant Critter' => 'admin/grants/pets']) !!}

<h1>Grant Critters</h1>
...
<div class="form-group">
    {!! Form::label('Critter(s)') !!} {!! add_help('Must have at least 1 critter and Quantity must be at least 1.') !!}
    <div id="petList">
        <div class="d-flex mb-2">
            {!! Form::select('pet_ids[]', $pets, null, ['class' => 'form-control mr-2 default pet-select', 'placeholder' => 'Select Critter']) !!}
    ...
    <div><a href="#" class="btn btn-primary" id="add-pet">Add Critter</a></div>
    <div class="pet-row hide mb-2">
        {!! Form::select('pet_ids[]', $pets, null, ['class' => 'form-control mr-2 pet-select', 'placeholder' => 'Select Critter']) !!}
        {!! Form::text('quantities[]', 1, ['class' => 'form-control mr-2', 'placeholder' => 'Quantity']) !!}
...
<div class="form-group">
    ...
    {!! Form::label('disallow_transfer', 'Account-bound', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If this is on, the recipient(s) will not be able to transfer this pet to other users. Critters that disallow transfers by default will still not be transferrable.') !!}
</div>
