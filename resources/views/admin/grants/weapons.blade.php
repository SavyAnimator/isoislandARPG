...
@section('admin-title') Grant Equipment@endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Grant Equipment' => 'admin/grants/weapons']) !!}

<h1>Grant Equipment</h1>
...
<div class="form-group">
    ...
    {!! Form::label('disallow_transfer', 'Account-bound', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If this is on, the recipient(s) will not be able to transfer this weapon to other users. Equipment that disallow transfers by default will still not be transferrable.') !!}
</div>
