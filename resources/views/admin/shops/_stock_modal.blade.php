    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('stock_type', ['Item' => 'Item', 'Pet' => 'Critter', 'Gear' => 'Accessory', 'Weapon' => 'Equipment'], $stock->stock_type ?? null, ['class' => 'form-control stock-field', 'placeholder' => 'Select Stock Type', 'id' => 'type']) !!}
            </div>
        </div>
        <div class="col-md-6">
