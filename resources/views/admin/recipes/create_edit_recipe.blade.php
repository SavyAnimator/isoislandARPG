...
{!! Form::close() !!}
    ...
    @include('widgets._recipe_ingredient_select_row', ['items' => $items, 'categories' => $categories, 'currencies' => $currencies, 'weapons' => $weapons, 'gears' => $gears])
    @include('widgets._recipe_reward_select_row', ['items' => $items, 'currencies' => $currencies, 'tables' => $tables, 'raffles' => $raffles, 'weapons' => $weapons, 'gears' => $gears])
