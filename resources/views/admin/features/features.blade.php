    ...
    <div class="mb-4 logs-table">
        <div class="logs-table-header">
            <div class="row">
                ...
                <div class="col-6 col-md-2"><div class="logs-table-cell">Breed</div></div>
            </div>
        </div>
            ...
            @foreach($features as $feature)
                <div class="logs-table-row">
                    <div class="row flex-wrap">
                        ...
                        <div class="col-12 col-md-1"><div class="logs-table-cell"><a href="{{ url('admin/data/traits/edit/'.($feature->parent_id ? $feature->parent_id : $feature->id)) }}" class="btn btn-primary py-0 px-1 w-100">Edit</a></div></div>
                    </div>
                </div>
                @endforeach
            </div>
