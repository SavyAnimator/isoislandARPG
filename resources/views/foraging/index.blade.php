...
<p>These dailies use stamina. In return you have a chance to receive some free loot. Loot varies from each game. Choose which game you'd like to play:</p>
...
@elseif($user->foraging->distribute_at <= $now && $user->foraging->forage_id)
    ...
    <div class="container text-center">
        ...
        {!! Form::open(['url' => 'foraging/claim' ]) !!}
            @if($user->foraging->forage->imageUrl)
