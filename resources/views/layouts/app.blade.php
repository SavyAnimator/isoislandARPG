...
<body>
    <div id="app">
        ...
        <div class="site-header-image" id="header" style="background-image: url('{{ $decoratorTheme?->headerImageUrl ?? $conditionalTheme?->headerImageUrl ?? $theme?->headerImageUrl ?? asset('images/header.png') }}');">
                <a href="/"><div width="50%" class="iso-logo"></div></a>
        </div>

        @include('layouts._nav')

        @if ( View::hasSection('sidebar') )
			<div class="site-mobile-header bg-primary"><a href="#" class="btn btn-sm btn-outline-white" id="mobileMenuButton">Menu <i class="fas fa-caret-right ml-1"></i></a></div>
		@endif
        ...
        <main class="container-fluid" id="main">
            <div class="row">
                ...
                <div class="main-content col-lg-8 p-4">
                    {{--<img src="https://grifixverse.com/images/over-bg.PNG" class="over-bg">--}}
                    <div>
                    ...
                    <div class="site-footer mt-2" id="footer">
        ...
        <script>
            $(function() {
                ...
                tinymce.init({
                    ...
                    toolbar: 'hr undo redo | formatselect | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | spoiler-add spoiler-remove | removeformat | code',
                    content_css: [
                        '{{ asset('css/app.css') }}',
