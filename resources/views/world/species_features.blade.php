...
@section('content')
{{--{!! breadcrumbs(['Index' => 'world', 'Species' => 'world/species', $species->name => $species->url, 'Traits' => 'world/species/'.$species->id.'traits']) !!}--}}
<h1>{{ $species->name }} Traits</h1>

<p>This is a visual index of all {!! $species->displayName !!}-specific traits. Click a trait to view more info on it or view the <a href="/world/traits?species_id={!! $species->id !!}">information trait index</a> which shows the description and image.</p>
