...
@section('content')
{{--{!! breadcrumbs(['Index' => 'world', 'Awards' => 'world/awards']) !!}--}}
<h1>Awards</h1>
...
<div class="row">
    @foreach($awards as $award)
        <div class="col-md-3 mb-3"><div class="card h-100">
            @if($award->has_image)
            ...
            @endif
             <div class="card-body text-center">
                <h5 class="mt-1">{!! $award->displayName !!}</h5>
...
<div class="text-center mt-3 small text-muted">{{ $awards->total() }} result{{ $awards->total() == 1 ? '' : 's' }} found.</div>
