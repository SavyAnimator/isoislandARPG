...
@section('title') Accessory @endsection

@section('content')
{{--{!! breadcrumbs(['Index' => 'world', 'Accessory' => 'world/gear']) !!}--}}
<h1>Accessory</h1>
...
@foreach($gears as $gear)
    <div class="card mb-3">
        <div class="card-body">
            <?php $shops = App\Models\Shop\Shop::whereIn('id', App\Models\Shop\ShopStock::where('stock_type', 'Gear')->where('item_id', $gear->id)->pluck('shop_id')->unique()->toArray())->orderBy('sort', 'DESC')->get(); ?>
