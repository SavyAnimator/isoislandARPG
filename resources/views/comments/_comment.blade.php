    ...
    <div class="media-body row mw-100 mx-0" style="flex:1;flex-wrap:wrap;">
        ...
        <div class="d-block" style="flex:1">
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row mx-0 px-0 align-items-md-end">
                        <h5 class="mt-0 mb-1 col mx-0 px-0">
                            {!! $comment->commenter->commentDisplayName !!} @if($comment->commenter->isStaff == true)<small class="text-success">Staff</small>@endif
                        </h5>
                        ...
                        <p class="text-right mb-0">
                            <small class="text-muted">{!! format_date($comment->created_at) !!}
                ...
                <div class="card-body">
                    <div class="{{ $comment->is_featured ? 'border-success bg-light' : '' }} ">
