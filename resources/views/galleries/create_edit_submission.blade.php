    ...
    @else
        ...
        <b>{!! Form::label('Image') !!}</b>
            ...
            {!! Form::file('image', ['id' => 'mainImage']) !!}
                <small>Images may be PNG, GIF, or JPG and up to 3MB in size. <br> If your image is larger than 3MB or 2000x2000 pixels you may receive an error when submitting and will have to reenter all following information.</small>
            </div>
        </div>

        <div class="form-group">
            <b>{!! Form::label('Text') !!}</b><br>
            <small>This can be a short description or an accompanying story to your image and will be viewable along with your image.</small>
