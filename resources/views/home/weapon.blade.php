...
@section('home-title') Equipment @endsection

@section('home-content')
{{--{!! breadcrumbs(['Equipment' => 'Equipment']) !!}--}}

<h1>
    Equipment
</h1>

<p>This is your equipment. Click on an equipment to view more details and actions you can perform on it.</p>
...
<div class="text-right mb-4">
    <a href="{{ url(Auth::user()->url.'/equipment-logs') }}">View logs...</a>
</div>
