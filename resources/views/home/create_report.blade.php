...
@else 
    ...
    <div class="br-form-group alert alert-warning" style="display: none">
		...
		<div class="form-group">
            {!! Form::label('category', 'Report Type') !!} 
            {!! Form::select('category', array('Bug' => 'Bug', 'Help' => 'Help/Question', 'Suggestion' => 'Suggestion', 'Site Feedback' => 'Site Feedback'), ['class' => 'form-control']) !!} 
        </div>
        <div class="form-group">
        ...
        <div class="text-right">
            <a href="#" class="btn btn-primary" id="submitButton">Submit Report</a>
        </div>
    {!! Form::close() !!}
