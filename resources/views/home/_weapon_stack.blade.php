        ...
        <div class="card mt-3">
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    ...
                    <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#attachForm">@if($stack->user_id != $user->id) [ADMIN] @endif Detach Equipment from Character</a>
                    {!! Form::open(['url' => 'equipment/detach/'.$stack->id, 'id' => 'attachForm', 'class' => 'collapse']) !!}
                    ...
                    <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#attachForm">@if($stack->user_id != $user->id) [ADMIN] @endif Attach Equipment to Character</a>
                    {!! Form::open(['url' => 'equipment/attach/'.$stack->id, 'id' => 'attachForm', 'class' => 'collapse']) !!}
                ...
                <li class="list-group-item">
                    <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#upgradeForm">@if($stack->user_id != $user->id) [ADMIN] @endif Upgrade Equipment</a>
                    {!! Form::open(['url' => 'equipment/upgrade/'.$stack->id, 'id' => 'upgradeForm', 'class' => 'collapse']) !!}
                        <p class="alert alert-info my-2">This equipment can be upgraded to {!!$stack->weapon->parent->displayName !!}!</p>
                ...
                <li class="list-group-item">
                    <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#imageForm"> [ADMIN] Unique Image to equipment</a>
                    {!! Form::open(['url' => 'equipment/image/'.$stack->id, 'files' => true, 'id' => 'imageForm', 'class' => 'collapse']) !!}
                ...
                @if($stack->isTransferrable || $user->hasPower('edit_inventories'))
                    ...
                    <li class="list-group-item">
                        <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#transferForm">@if($stack->user_id != $user->id) [ADMIN] @endif Transfer Equipment</a>
                        {!! Form::open(['url' => 'equipment/transfer/'.$stack->id, 'id' => 'transferForm', 'class' => 'collapse']) !!}
                            ...
                            @endif
                            <div class="form-group">
                                {!! Form::label('user_id', 'Recipient') !!} {!! add_help('You can only transfer wequipment to verified users.') !!}
                ...
                @endif
                <li class="list-group-item">
                    <a class="card-title h5 collapse-title"  data-toggle="collapse" href="#deleteForm">@if($stack->user_id != $user->id) [ADMIN] @endif Delete Equipment</a>
                    {!! Form::open(['url' => 'sequipment/delete/'.$stack->id, 'id' => 'deleteForm', 'class' => 'collapse']) !!}
