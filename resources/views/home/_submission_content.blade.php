    ...
    <div class="row m-2">
        <div class="col-md">
            ...
            {{ $submission->prompt->expreward->chara_exp ? $submission->prompt->expreward->chara_exp : 0  }} character EXP
                <br>
            {{ $submission->prompt->expreward->chara_points ? $submission->prompt->expreward->chara_points : 0  }} stat points
            @endif
        </div>
        {{--<div class="col-md">
            <h5>User Rewards</h5>
        ...
        <div class="row m-2">
            ...
            <div class="col-md">
                ...
                {{ $bonus[0]['Character_Bonus']['exp'] ? $bonus[0]['Character_Bonus']['exp'] : 'No bonus'}} character EXP
                    <br>
                {{ $bonus[0]['Character_Bonus']['points'] ? $bonus[0]['Character_Bonus']['points'] : 'No bonus'}} stat points
            </div>
        </div>
        <hr>
    @endif
