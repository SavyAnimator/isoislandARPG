...
@section('title') Donate Character @endsection
...
<div class="alert alert-danger">Charactrer donations are currently closed</div>
@else
<div class="alert alert-warning">Please note that by donating your characters you acknowledge they will be sold for onsite currency and retrieval after the form has been approved may not be possible</div>
