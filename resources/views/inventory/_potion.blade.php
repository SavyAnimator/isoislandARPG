<li class="list-group-item">
    <a class="card-title h5 collapse-title" data-toggle="collapse" href="#openPotionForm"> Use Consumable</a>
    <div id="openPotionForm" class="collapse">
        ...
        <p>This action is not reversible. Are you sure you want to eat this item?</p>
        {{-- select character --}}
