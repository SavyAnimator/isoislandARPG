    ...
    **********************************************************************************************/
    ...
    public function getIngredientAttribute()
    {
        switch ($this->ingredient_type)
        {
            ...
            case 'Gear':
                return App\Models\Claymore\Gear::where('id', $this->data[0])->get()[0];
            case 'Weapon':
                return App\Models\Claymore\Weapon::where('id', $this->data[0])->get()[0];
            case 'MultiWeapon':
                return App\Models\Claymore\Weapon::whereIn('id', $this->data)->get();
        }
        return null;
    }
}
