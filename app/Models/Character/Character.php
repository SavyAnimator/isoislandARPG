...
class Character extends Model
{
    ...
    protected $fillable = [
        ...
        'is_gift_art_allowed', 'is_gift_writing_allowed', 'is_trading', 'sort', 'is_explore', 'is_training',
        'is_myo_slot', 'name', 'trade_id', 'owner_url', 'class_id', 'gender_identity', 'personal_pronouns', 'chara_height', 'is_condensed', 'folder_id'
