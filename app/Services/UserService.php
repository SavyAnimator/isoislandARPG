...
class UserService extends Service {
    ...
    */
    ...
    /**
     * Updates user's online setting
     */
    public function updateONL($data, $user) {
        $user->settings->online_setting = $data;
        $user->settings->save();
    ...
    public function ban($data, $user, $staff) {
        ...
        try {
            if(!$user->is_banned) {
                // New ban (not just editing the reason), clear all their engagement
