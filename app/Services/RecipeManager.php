            ...
            if($selectedStacks) {
                switch($ingredient->ingredient_type)
                {
                    ...
                    case 'Currency':
                        continue 2;
                    case 'Gear':
                        $stacks = $selectedStacks->where('gear.id', $ingredient->data[0]);
                        break;
                    case 'Weapon':
                        $stacks = $selectedStacks->where('weapon.id', $ingredient->data[0]);
                        break;
                    case 'MultiWeapon':
                        $stacks = $selectedStacks->whereIn('weapon.id', $ingredient->data);
                        break;
                }
            }
            else {
                switch($ingredient->ingredient_type)
                {
                    ...
                    case 'Currency':
                        continue 2;
                    case 'Gear':
                        $stacks = $user_items->where('gear.id', $ingredient->data[0]);
                        break;
                    case 'Weapon':
                        $stacks = $user_items->where('weapon.id', $ingredient->data[0]);
                        break;
                    case 'MultiWeapon':
                        $stacks = $user_items->whereIn('weapon.id', $ingredient->data);
                        break;
                }
            }
