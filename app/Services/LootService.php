    ...
    */
    ...
    public function updateLootTable($table, $data) {
        ...
        try {
            ...
            $table->update(Arr::only($data, ['name', 'display_name', 'data', 'rolls']));

            $this->populateLootTable($table, Arr::only($data, ['rewardable_type', 'rewardable_id', 'quantity', 'weight', 'criteria', 'rarity', 'subtable_id', 'guaranteed_loot_ids']));
