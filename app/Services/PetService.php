    ...
    **********************************************************************************************/
    ...
    public function deletePet($pet)
    {
        ...
        try {
            ...
            if(DB::table('loots')->where('rewardable_type', 'Pet')->where('rewardable_id', $pet->id)->exists()) throw new \Exception("A loot table currently distributes this critter as a potential reward. Please remove the pet before deleting it.");
    ...
    public function editVariants($data, $pet)
    {
        ...
        try {
            ...
            if(isset($data['variant_name'])) {
                foreach($data['variant_name'] as $key => $type) {
