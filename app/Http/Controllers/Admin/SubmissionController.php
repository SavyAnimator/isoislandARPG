...
class SubmissionController extends Controller
{
    ...
    {
        $data = $request->only(['slug',  'character_quantity', 'character_rewardable_quantity', 'character_rewardable_id',  'character_rewardable_type', 'character_currency_id', 'rewardable_type', 'rewardable_id', 'quantity', 'staff_comments', 'character_is_focus', 'bonus_exp', 'bonus_points', 'bonus_user_exp', 'bonus_user_points',
