...
class LootTableController extends Controller {
    ...
    */
    ...
    public function postCreateEditLootTable(Request $request, LootService $service, $id = null) {
        ...
        $data = $request->only([
            'name', 'display_name', 'rewardable_type', 'rewardable_id', 'quantity', 'weight', 'subtable_id', 'criteria', 'rarity', 'sublist_status_id', 'sublist_criteria', 'sublist_quantity', 'rolls', 'guaranteed_loot_ids'
        ]);
