...
class MyoController extends Controller
{
    ...
    */
    ...
    public function postEditCharacterProfile(Request $request, CharacterManager $service, $id)
    {
        ...
        if($service->updateCharacterProfile($request->only(['text', 'gender_identity', 'personal_pronouns', 'is_gift_art_allowed', 'is_trading',  'is_training', 'is_explore', 'chara_height', 'alert_user', 'is_condensed']), $this->character, Auth::user(), !$isOwner)) {
